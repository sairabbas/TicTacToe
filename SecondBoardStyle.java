...
/**
 * This is strategy concrete class implementing strategy interface
 * BoardStyle.java Methods defined in the BoardStyle strategy interface are
...
public class SecondBoardStyle implements BoardStyle {
    ...
    /**
     * SecondBoardStyle has chosen to use DefaultMetalTheme The below method sets
     * the DefaultMetalTheme in UIManager. When the board is created the board uses
     * DefaultMetalTheme style. The setBoardTheme invoked from TicTacToeBoard
